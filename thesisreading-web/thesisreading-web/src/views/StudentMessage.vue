...
export default {
  ...
  methods: {
    ...
    convert() {
      ...
      axios
        .get(
          "http://localhost:8080/student/paper/message/list?paperId=" +
    ...
    addMessage() {
      // Ajax请求
      axios
          .get("http://localhost:8080/student/paper/message/info/all", {
            headers: {
              Token: window.localStorage["Token"]
            }
          })
        ...
        this.$confirm("确定发布评论？", "提示", {
          ...
          type: "info"
            ...
            .then(() => {
              axios
                  .post(
                      "http://localhost:8080/student/paper/message/add",
                      {
                        paperId:this.$route.params.paperId,
  ...
  clickBack() {
    this.$router.push({ path: "/student/paper" });
  }
  }
};
</script>
